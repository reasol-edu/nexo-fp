...
final class Version20260625000000 extends AbstractMigration
{
    ...
    {
        return 'Bloqueo optimista: columna training_position.version (SQLite)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE training_position ADD COLUMN version INTEGER NOT NULL DEFAULT 1');
    }
